...
import geopriv4j.MovingInTheNeighbourhoodAlgorithm;
...
public class MapsActivityMovingInTheNeighbourhood extends FragmentActivity implements OnMapReadyCallback {
    ...
    public MovingInTheNeighbourhoodAlgorithm algorithm;
    public geopriv4j.utils.LatLng topleft;
    public geopriv4j.utils.LatLng bottomright;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            locationCallback = new LocationCallback() {
                ...
                public void onLocationResult(LocationResult locationResult) {
                    ...
                    if (location != null) {
                        ...
                        mapFragment.getMapAsync(MapsActivityMovingInTheNeighbourhood.this);
        ...
        //Set boundaries to generate location within. For this example, location will be UNCC campus.
        //If leaving these values make sure to set Android emulator location to a location within these bounds.
        topleft = new geopriv4j.utils.LatLng(35.315945, -80.744016);
        bottomright = new geopriv4j.utils.LatLng(35.301534, -80.724108);
        ...
        //generate dummy locations using the MovingInTheNeighbourhoodAlgorithm
        algorithm = new MovingInTheNeighbourhoodAlgorithm(topleft, bottomright, offset, n);
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //See onCreate() method for Algorithm initialization

        LatLng topleft_LatLng = new LatLng(topleft.latitude, topleft.longitude);
        LatLng bottomright_LatLng = new LatLng(bottomright.latitude, bottomright.longitude);
        ...
        ArrayList<geopriv4j.utils.LatLng> generated_locations = algorithm.generate(location);
        for (int i = 0; i < generated_locations.size(); i++) {
            ...
            //Plot the generated locations on the map
