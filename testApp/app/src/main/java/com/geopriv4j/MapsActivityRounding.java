...
public class MapsActivityRounding extends FragmentActivity implements OnMapReadyCallback {
            ...
            locationCallback = new LocationCallback() {
                ...
                public void onLocationResult(LocationResult locationResult) {
                    ...
                    if (location != null) {
                        ...
                        mapFragment.getMapAsync(MapsActivityRounding.this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //Generate dummy locations using the RoundingAlgorithm from geopriv4j package
